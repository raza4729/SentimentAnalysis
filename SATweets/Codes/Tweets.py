...
class StreamListener(tweepy.StreamListener):
    ...
    def on_data(self, data):
        ...
        loc = data.split('{"created_at":"')[1].split(',"id"')[0]

        saveThis = loc + '                       :: ' + tweet
        saveFile = open('Election2016.txt', 'a', encoding='utf-8')
...
if __name__ == "__main__":
    ...
    consumer_key = "T1lmquCp1VW8R51K0pfdBPQXt"
    consumer_secret = "fSBQvBV87bvFIUx0DJR2cRG4U6lIVf8q5hcPX8vl8Y2N1wqezb"
    access_token = "744758660-oM96JYBNZNRSykFk9bpvXX1UrXjBr6scEGMEKfoF"
    access_token_secret = "TVJVChHomCadaJX0gtWygjCuDIdHa3yGrIt1Uf64shK8C"
    ...
    stream.filter(locations=LOCATIONS, track=["#Election2016"], languages=["en"])
